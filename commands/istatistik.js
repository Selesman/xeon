...
exports.run = async (client, message, args) => {
  ...
  const istatistikler = new Discord.MessageEmbed()
    ...
    .addField("**__Bot Sahibi__**", `<@337651044639047680>`, true)
    .addField("**__Geliştirici__**", `<@337651044639047680>  , <@788108901555634256>`, true)
    .addField("**__İşletim Sistemi__**", ` \` Linux | Kali Linux \` `, true)
    .addField("**__İşlemci__**",` \`\`\`Intel Xeon W-3275M @ 2.50GHz - @ 4.40GHz \`\`\` `)
